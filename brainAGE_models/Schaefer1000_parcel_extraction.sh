...
################################################################################
aparcstats2table --hemi lh --subjects *sub0* --parc Schaefer1000 --meas area --tablefile lh.Schaefer1000_area.txt
aparcstats2table --hemi rh --subjects *sub0* --parc Schaefer1000 --meas area --tablefile rh.Schaefer1000_area.txt
aparcstats2table --hemi lh --subjects *sub0* --parc Schaefer1000 --meas thickness --tablefile lh.Schaefer1000_thickness.txt
aparcstats2table --hemi rh --subjects *sub0* --parc Schaefer1000 --meas thickness --tablefile rh.Schaefer1000_thickness.txt